...
> **File này tự chứa.** Toàn bộ prompt và mọi tài liệu đầu vào đã gộp vào đây, không
> cần mở repo. Dán hoặc tải file này lên phiên Claude Design là đủ.
>
> Đóng gói: Cowork, 2026-08-06. Repo `tourdaovn`, commit `055b706`.
...
> **Ghi chú về đường dẫn.** Prompt trên nhắc tới đường dẫn file trong repo. Trong gói này
> nội dung các file đó đã có sẵn ở mục 2–6 bên dưới; không cần mở repo để đọc.
