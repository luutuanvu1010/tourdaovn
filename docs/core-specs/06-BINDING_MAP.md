...
- **Phiên bản:** v2.3.0 (**nháp, chờ chủ dự án chốt**)   **Trạng thái:** v2.0.0 là bản mở cổng bước 7 ngày 2026-08-06 (QĐ-2026-08-06-06); v2.1.0 (đợt 4B) duyệt 2026-08-22, QĐ-2026-08-22-02; **v2.2.0 duyệt 2026-08-22, QĐ-2026-08-22-05** — đổi ở §3, §3.1, §6, §4.8, §4.10, §7 và §7.1 (sửa theo N18: bản đầu của dòng này khai thiếu bốn mục sau); **v2.3.0 NHÁP 2026-08-23** — đoạn mở rời hero (§3, §3.1) và Luật 5 cột→hàng ở di động (§6), theo hai quyết định của chủ dự án trong phiên brainstorm 2026-08-22. Chưa có QĐ; xem `QĐ-2026-08-23-02` (nháp)
