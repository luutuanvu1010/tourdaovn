...
## DR-046 — Sáu URL `/tour/` chết sau đợt đổi slug 22/08; lệch luật R3 có ý thức
...
Đợt biên tập nội dung 2026-08-22 (xem `DR-045`) đổi slug nhiều tour. Sau khi phát hành, sáu URL
