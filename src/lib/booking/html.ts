...
export function renderBookingPage(o: { title: string; heading: string; lines: string[]; backHref: string; backLabel: string; ok: boolean }): string {
...
<p style="margin:20px 0 0"><a href="${escapeHtml(o.backHref)}">← Về trang ${escapeHtml(o.backLabel)}</a> · <a href="/lien-he/">Trang liên hệ</a></p>
</main></body></html>`
}
